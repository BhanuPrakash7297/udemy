        ...
        >
          <Tab
            style={{
              ...
              ...(selectedTab === 0 &&
                selectedTabHovered && { backgroundColor: "#3e4143" }),
            }}
            sx={{
              borderBottom: "none",
            }}
            ...
            label={
              <Typography
                ...
                sx={{
                  ...
                  lineHeight: "normal",
                  "&.Mui-focusVisible": {
                    // Remove the blue bottom border
                    outline: "none",
                    borderBottom: "none",
                  },
                }}
              >
                <span style={{ color: selectedTab == 0 ? "#fff" : "black" }}>
                  {Title}
                </span>
                ...
                <span
                  style={{
                    fontSize: "10px",
                    color: selectedTab === 0 ? "#fff" : "#6a6f73",
                    marginTop: "-4px",
                  }}
                >
                  {learnerNumber}M+learner
                </span>
              </Typography>
            }
          />
          <Tab
            ...
            label={
              ...
              >
                <span style={{ color: selectedTab === 1 ? "#fff" : "black" }}>
                  {Title}
                </span>
                <br style={{ marginTop: "-8px" }} />
                <span
                  style={{
                    fontSize: "12px",
                    color: selectedTab === 1 ? "#fff" : "#6a6f73",
                    marginTop: "-4px",
                  }}
                >
                  {learnerNumber}M+learner
          ...
          <Tab
            style={{
              ...
              ...(selectedTab === 2 &&
                selectedTabHovered && { backgroundColor: "#3e4143" }), // Change this to your desired color
            }}
            onMouseOver={() => {
              if (selectedTab === 2) {
                setSelectedTabHovered(true);
            ...
            label={
              ...
              >
                <span style={{ color: selectedTab === 2 ? "#fff" : "black" }}>
                  {Title}
                </span>
                <br style={{ marginTop: "-8px" }} />
                <span
                  style={{
                    fontSize: "10px",
                    color: selectedTab === 2 ? "#fff" : "#6a6f73",
                    marginTop: "-4px",
                  }}
                >
                  {learnerNumber}M+learner
          ...
          <Tab
            ...
            label={
              ...
              >
                <span style={{ color: selectedTab === 3 ? "#fff" : "black" }}>
                  {Title}
                </span>
                <br style={{ marginTop: "-8px" }} />
                <span
                  style={{
                    fontSize: "10px",
                    color: selectedTab === 3 ? "#fff" : "#6a6f73",
                    marginTop: "-4px",
                  }}
                >
                  {learnerNumber}M+learner
          ...
          <Tab
            ...
            label={
              ...
              >
                <span style={{ color: selectedTab === 4 ? "#fff" : "black" }}>
                  {Title}
                </span>
                <br style={{ marginTop: "-8px" }} />
                <span
                  style={{
                    fontSize: "10px",
                    color: selectedTab === 4 ? "#fff" : "#6a6f73",
                    marginTop: "-4px",
                  }}
                >
                  {learnerNumber}M+learner
          ...
          <Tab
            ...
            label={
              ...
              >
                <span style={{ color: selectedTab === 5 ? "#fff" : "black" }}>
                  {Title}
                </span>
                <br style={{ marginTop: "-8px" }} />
                <span
                  style={{
                    fontSize: "10px",
                    color: selectedTab === 5 ? "#fff" : "#6a6f73",
                    marginTop: "-4px",
                  }}
                >
                  {learnerNumber}M+learner
          ...
          <Tab
            ...
            label={
              ...
              >
                <span style={{ color: selectedTab === 6 ? "#fff" : "black" }}>
                  {Title}
                </span>
                <br style={{ marginTop: "-8px" }} />
                <span
                  style={{
                    fontSize: "10px",
                    color: selectedTab === 6 ? "#fff" : "#6a6f73",
                    marginTop: "-4px",
                  }}
                >
                  {learnerNumber}M+learner
          ...
          <Tab
            ...
            label={
              ...
              >
                <span style={{ color: selectedTab === 7 ? "#fff" : "black" }}>
                  {Title}
                </span>
                <br style={{ marginTop: "-8px" }} />
                <span
                  style={{
                    fontSize: "10px",
                    color: selectedTab === 7 ? "#fff" : "#6a6f73",
                    marginTop: "-4px",
                  }}
                >
                  {learnerNumber}M+learner
